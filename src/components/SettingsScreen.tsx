  ...
  return (
    <Container>
      ...
      <div className="mt-8 space-y-6">
        <LanguageSetting currentLanguage={currentLanguage} onLanguageChange={changeLanguage} />

        <WordCountSetting wordCount={wordCount} onWordCountChange={onWordCountChange} />
